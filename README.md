...
|---------------------|--------------------|--------------|
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software. | <ul><li><b>Sergio Aguirre</b><br><b>TP1:</b> Asumí el rol de líder del equipo: definí alcance de la entrega, prioricé tareas y coordiné dependencias. Elaboré las secciones del <i>segmento objetivo 2</i> y <i>User Stories</i>, y revisé la coherencia entre artefactos.</li><li><b>María Elena Muñoz Machuca</b><br><b>TP1:</b> Desarrollé el <i>context mapping</i>, los <i>bounded context canvases</i> y la <i>software architecture</i> del bounded context de pagos y suscripciones, asegurando alineamiento con los objetivos del producto.</li><li><b>Víctor Manuel Rojas Reátegui</b><br><b>TP1:</b> Participé en reuniones de revisión técnica, propuse la estructura de paquetes y convenciones del repo y apoyé en la integración de entregables.</li><li><b>Luis Montañez</b><br><b>TP1:</b> Coordine la consolidación del informe y la estandarización de formatos; verifiqué criterios de aceptación y consistencia visual.</li><li><b>Joseph Rodríguez</b><br><b>TP1:</b> Contribuí en el prototipo, apoyé la redacción del informe y gestioné el seguimiento de tareas cruzadas entre frentes.</li></ul> | <ul><li><b>TP1:</b> Se fortalecieron y actualizaron conocimientos de arquitectura, modelado y organización del código. La elaboración de artefactos (context mapping, BCC y arquitectura) consolidó criterios comunes y mejoró la calidad técnica del proyecto, potenciando el desarrollo profesional del equipo.</li></ul> |
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software. | <ul><li><b>Sergio Aguirre</b><br><b>TP1:</b> Gestioné el tablero en Trello (priorización/seguimiento), coordiné sesiones en Miro (As-Is/To-Be) y validé wireframes en Figma.</li><li><b>María Elena Muñoz Machuca</b><br><b>TP1:</b> Apliqué buenas prácticas de documentación en los artefactos de arquitectura y ajusté el diseño a feedback iterativo.</li><li><b>Víctor Manuel Rojas Reátegui</b><br><b>TP1:</b> Elaboré wireframes de la Landing Page y organicé ramas/flujo de trabajo en GitHub (naming, PRs y revisiones).</li><li><b>Luis Montañez</b><br><b>TP1:</b> Planificación conjunta con hitos claros, gestión de riesgos y distribución de tareas para evitar cuellos de botella.</li><li><b>Joseph Rodríguez</b><br><b>TP1:</b> Cumplí tareas puntualmente, ayudé a definir objetivos realistas y mantuve comunicación continua en los canales acordados.</li></ul> | <ul><li><b>TP1:</b> El uso integrado de Trello, Miro y Figma, junto con un flujo Git disciplinado, evidenció aprendizaje continuo y adaptación a prácticas ágiles. Esto elevó las competencias individuales/colectivas y mejoró la eficiencia y trazabilidad del proyecto.</li></ul> |
